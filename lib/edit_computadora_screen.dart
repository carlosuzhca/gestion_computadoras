...
import '../db/database_helper.dart'; // Asegúrate de que este sea el archivo correcto
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        ...
        builder: (context, AsyncSnapshot<List<Computadora>> snapshot) {
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  ...
                  trailing: IconButton(
                    ...
                    onPressed: () {
                      // Lógica para eliminar una computadora
                    },
                  ),
                  onTap: () {
